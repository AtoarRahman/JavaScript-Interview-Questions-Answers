...
**Note:** This repository is specific to JavaScript Please check [React Interview Questions & Answers](https://github.com/AtoarRahman/React-Interview-Questions-Answers) for core ReactJS. questions.
